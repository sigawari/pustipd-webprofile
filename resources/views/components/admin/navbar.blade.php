    ...
    <div class="flex items-center justify-between px-4 py-3 lg:px-6">
        ...
        <div class="flex items-center space-x-3 min-w-0 flex-1 lg:flex-none">
            ...
            <button @click="$dispatch('toggle-sidebar')"
                class="flex items-center justify-center w-10 h-10 rounded-lg text-gray-600 hover:bg-gray-100 lg:hidden transition-colors duration-200 flex-shrink-0">
            ...
            <button @click="$dispatch('toggle-sidebar')"
                class="hidden lg:flex items-center justify-center w-10 h-10 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors duration-200 flex-shrink-0">
