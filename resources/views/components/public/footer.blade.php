        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <div class="flex gap-3 mt-5">
                    <!-- Instagram -->
                    @if (isset($footerData['social_media']['instagram_url']) && !empty($footerData['social_media']['instagram_url']))
                        <a href="{{ $footerData['social_media']['instagram_url'] }}" target="_blank" rel="noopener"
                    ...
                    <!-- Facebook -->
                    @if (isset($footerData['social_media']['facebook_url']) && !empty($footerData['social_media']['facebook_url']))
                        <a href="{{ $footerData['social_media']['facebook_url'] }}" target="_blank" rel="noopener"
                            class="w-9 h-9 bg-white rounded-full flex items-center justify-center text-[#062749] hover:bg-[#062749] hover:border-white border hover:text-white transform hover:scale-110 hover:-translate-y-1 transition duration-200 ease-out">
                    ...
                    <!-- YouTube -->
                    @if (isset($footerData['social_media']['youtube_url']) && !empty($footerData['social_media']['youtube_url']))
                        <a href="{{ $footerData['social_media']['youtube_url'] }}" target="_blank" rel="noopener"
                            class="w-9 h-9 bg-white rounded-full flex items-center justify-center text-[#062749] hover:bg-[#062749] hover:border-white border hover:text-white transform hover:scale-110 hover:-translate-y-1 transition duration-200 ease-out">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                    ...
                    <!-- Email -->
                    @if (isset($footerData['social_media']['email']) && !empty($footerData['social_media']['email']))
                        <a href="mailto:{{ $footerData['social_media']['email'] }}" target="_blank" rel="noopener"
                            class="w-9 h-9 bg-white rounded-full flex items-center justify-center text-[#062749] hover:bg-[#062749] hover:border-white border hover:text-white transform hover:scale-110 hover:-translate-y-1 transition duration-200 ease-out">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
            ...
            <div class="footer-dropdown">
                ...
                <div class="footer-dropdown-content mt-4 space-y-2">
                    @if (isset($footerData['applications']['items']) && !empty($footerData['applications']['items']))
                        @foreach ($footerData['applications']['items'] as $app)
                            <a href="{{ $app['url'] ?? '#' }}"
                                ...
                                target="_blank">
                                {{ $app['name'] ?? 'Link Aplikasi PUSTIPD' }}
                            </a>
                        @endforeach
                    @endif
                </div>
            ...
            <div class="footer-dropdown">
                ...
                <div class="footer-dropdown-content mt-4 space-y-2">
                    @if (isset($footerData['faculties']['items']) && !empty($footerData['faculties']['items']))
                        @foreach ($footerData['faculties']['items'] as $faculty)
                            <a href="{{ $faculty['url'] ?? '#' }}"
                                class="block text-sm text-blue-100 hover:text-white transition-colors duration-200"
                                target="_blank">
                                {{ $faculty['name'] ?? 'Link Fakultas di UIN RF' }}
                            </a>
                        @endforeach
                    @endif
                </div>
            ...
            <div class="footer-dropdown">
                ...
                <div class="footer-dropdown-content mt-4 space-y-2">
                    @if (isset($footerData['institutions']['items']) && !empty($footerData['institutions']['items']))
                        @foreach ($footerData['institutions']['items'] as $institution)
                            <a href="{{ $institution['url'] ?? '#' }}"
                                class="block text-sm text-blue-100 hover:text-white transition-colors duration-200"
                                target="_blank">
                                {{ $institution['name'] ?? 'Link Institusi di UIN RF' }}
                            </a>
                        @endforeach
                    @endif
                </div>
