        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
            <div class="flex justify-center space-x-2">
                ...
                <button onclick="toggleVisibility(this)"
                    ...
                    <svg class="w-4 h-4 icon-show" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
    ...
    <tr class="hover:bg-gray-50">
        <td colspan="6" class="px-6 py-4 text-center text-gray-500 italic">
            <div class="flex flex-col items-center justify-center text-sm text-gray-500 space-y-1">
                @if ($pencapaians->isEmpty() && !request()->filled('search') && !request()->filled('filter'))
                    ...
                    <span class="text-blue-500 font-medium">Belum ada Pencapaian yang tersedia.</span>
                @elseif ($pencapaians->isEmpty() && request()->filled('search'))
                ...
                @elseif ($pencapaians->isEmpty() && request()->filled('filter'))
