...
<div id="AddModal"
    ...
    <div
        ...
        <!-- Form -->
        <form id="addForm" method="POST" action="{{ route('admin.beranda.mitra.store') }}" class="space-y-4"
            ...
            <div>
                ...
                <textarea name="name" id="name" rows="2" required
                    ...
                    placeholder="Tulis nama mitra....">{{ old('name') }}</textarea>
                @error('name')
            ...
            <!-- Gambar Logo -->
            <div>
                <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Logo Mitra</label>
            ...
            <div class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start">
                ...
                <p class="text-sm text-yellow-800">Mitra akan disimpan sebagai <strong>Draft</strong> dan belum tampil
                    di
                    halaman publik.</p>
            </div>
