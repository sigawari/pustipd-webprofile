<x-admin.layouts>
    ...
    @section('page-title', 'Mitra PUSTIPD')
    @section('page-description', 'Kelola konten Mitra PUSTIPD yang akan masuk ke beranda web PUSTIPD')
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <!-- Button Export -->
                <a href="{{ route('admin.beranda.mitra.export', [
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.beranda.mitra.bulk') }}";
        </script>
        ...
        <div class="flex flex-col gap-3 mb-4 sm:mb-6">
            <div class="relative">
                ...
                <input type="search" id="search-input" value="{{ request('search') }}"
                    data-url="{{ route('admin.beranda.mitra.index') }}" data-target="mitraTableBody"
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                <select id="filter-select" name="filter" data-url="{{ route('admin.beranda.mitra.index') }}"
                    data-target="mitraTableBody"
                ...
                <select id="perpage-select" name="perPage" data-url="{{ route('admin.beranda.mitra.index') }}"
                    data-target="mitraTableBody"
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="mitraTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.Beranda.Mitra.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 pt-4">
            ...
            <div class="text-sm text-gray-500 text-center sm:text-left">
                Menampilkan {{ $mitras->firstItem() }} sampai {{ $mitras->lastItem() }} dari
                {{ $mitras->total() }}
                {{ strtolower($title) }}
            </div>
    ...
    @include('admin.beranda.mitra.create')
    @include('admin.beranda.mitra.update')
    @include('admin.beranda.mitra.delete')
</x-admin.layouts>
