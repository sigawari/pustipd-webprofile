...
<div id="AddModal"
    ...
    <div
        ...
        <!-- Form -->
        <form id="addForm" method="POST" action="{{ route('admin.faq.store') }}" class="space-y-4">
            @csrf
            ...
            <div class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start">
                ...
                <p class="text-sm text-yellow-800">FAQ akan disimpan sebagai <strong>Draft</strong> dan belum tampil di
                    halaman publik.</p>
            </div>
