<x-admin.layouts>
    ...
    @section('page-description', 'Kelola konten FAQ UIN Raden Fatah Palembang')
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm">Kelola {{ $title }} yang akan ditampilkan di halaman FAQ</p>
            </div>
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.faq.bulk') }}";
        </script>
        ...
        <div class="flex flex-col gap-3 mb-4 sm:mb-6">
            <div class="relative">
                ...
                <input type="search" id="search-input" value="{{ request('search') }}"
                    data-url="{{ route('admin.faq.index') }}" data-target="faqTableBody"
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                <select id="filter-select" name="filter" data-url="{{ route('admin.faq.index') }}"
                ...
                <select id="perpage-select" name="perPage" data-url="{{ route('admin.faq.index') }}"
                    data-target="faqTableBody"
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="faqTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.FAQ.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
