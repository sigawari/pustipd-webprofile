<x-admin.layouts>
        ...
        <div class="flex flex-col gap-3 mb-4 sm:mb-6">
            <div class="relative">
                ...
                <input type="search" id="search-input" value="{{ request('search') }}"
                    data-url="{{ route('admin.sistem.manage-users.index') }}" data-target="usersTableBody"
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                <select id="filter-select" name="filter" data-url="{{ route('admin.sistem.manage-users.index') }}"
                ...
                <select id="perpage-select" name="perPage" data-url="{{ route('admin.sistem.manage-users.index') }}"
                    data-target="usersTableBody"
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="usersTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.sistem.manage-users.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <!-- Modal -->
    @include('admin.sistem.manage-users.create')
    @include('admin.sistem.manage-users.update')
    @include('admin.sistem.manage-users.delete')
</x-admin.layouts>
