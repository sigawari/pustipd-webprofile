<x-admin.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <!-- Button Export -->
                <a href="{{ route('admin.dokumen.regulasi.export', [
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.dokumen.regulasi.bulk') }}";
        </script>
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="RegulasiTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.dokumen.regulasi.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    @include('admin.dokumen.regulasi.create')
    @include('admin.dokumen.regulasi.update')
    @include('admin.dokumen.regulasi.delete')
</x-admin.layouts>
