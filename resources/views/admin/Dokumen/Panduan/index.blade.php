<x-admin.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <!-- Button Export -->
                <a href="{{ route('admin.dokumen.panduan.export', [
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.dokumen.panduan.bulk') }}";
        </script>
        ...
        <div class="flex flex-col gap-3 mb-4 sm:mb-6">
            <div class="relative">
                ...
                <input type="search" id="search-input" value="{{ request('search') }}"
                    data-url="{{ route('admin.dokumen.panduan.index') }}"
                    data-target="PanduanTableBody"
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="PanduanTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.dokumen.panduan.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    @include('admin.dokumen.panduan.create')
    @include('admin.dokumen.panduan.update')
    @include('admin.dokumen.panduan.delete')
</x-admin.layouts>
