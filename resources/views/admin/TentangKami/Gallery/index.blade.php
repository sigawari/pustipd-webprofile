<x-admin.layouts>
    ...
    @section('page-title', 'Gallery PUSTIPD')
    @section('page-description', 'Kelola konten Gallery UIN Raden Fatah Palembang')
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm">Kelola {{ $title }} yang akan ditampilkan di halaman Gallery
                </p>
            </div>
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.tentang-kami.gallery.bulk') }}";
        </script>
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="GalleryTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.TentangKami.Gallery.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    @include('admin.TentangKami.Gallery.create')
    @include('admin.TentangKami.Gallery.update')
    @include('admin.TentangKami.Gallery.delete')
</x-admin.layouts>
