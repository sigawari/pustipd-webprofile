<!-- Modal Hapus Tutorial -->
@foreach ($kelolaTutorials as $tutorial)
    <div id="DeleteModal-{{ $tutorial->id }}"
        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
            ...
            <form method="POST"
                action="{{ route('admin.manage-content.tutorial.kelolatutorial.destroy', $tutorial->id) }}">
                @csrf
                @method('DELETE')

                <div class="flex justify-end space-x-2">
                    <button type="button" onclick="closeDeleteModal('{{ $tutorial->id }}')"
            ...
            <!-- Tombol X di pojok -->
            <button onclick="closeDeleteModal('{{ $tutorial->id }}')"
