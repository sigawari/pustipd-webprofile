<x-admin.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.manage-content.dokumen.sop.bulk') }}";
        </script>
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="sopTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.manage-content.dokumen.sop.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    @include('admin.manage-content.dokumen.sop.create')
    @include('admin.manage-content.dokumen.sop.update')
    @include('admin.manage-content.dokumen.sop.delete')
</x-admin.layouts>
