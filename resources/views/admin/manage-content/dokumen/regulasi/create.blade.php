...
<div id="AddModal" class="hidden fixed inset-0 z-50 bg-black/50 items-center justify-center px-4">
    <div class="relative w-full max-w-lg max-h-[90vh] overflow-y-auto bg-white rounded-xl shadow-lg p-6">
        ...
        <!-- Form -->
        <form id="addForm" method="POST" action="{{ route('admin.manage-content.dokumen.regulasi.store') }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="title" required placeholder="Masukkan judul regulasi..."
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4" required placeholder="Tulis deskripsi regulasi..."
                    class="w-full px-3 py-2 border border-gray-200 rounded-lg 
            ...
            <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-center">
                    ...
                    <p class="text-sm text-blue-800">
                        Regulasi akan disimpan sebagai <strong>Draft</strong> dan belum tampil di halaman publik.
                    </p>
                </div>
            </div>
