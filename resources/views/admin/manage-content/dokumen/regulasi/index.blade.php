<x-admin.layouts>
    ...
    @section('page-description', 'Kelola konten Regulasi UIN Raden Fatah Palembang')
    @section('breadcrumb')
        <li>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.manage-content.dokumen.regulasi.bulk') }}";
        </script>
            ...
            <div class="min-w-full inline-block align-middle">
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="RegulasiTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.manage-content.dokumen.regulasi.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 pt-4">
            <div class="text-sm text-gray-500 text-center sm:text-left">
                Menampilkan {{ $regulasis->firstItem() }} sampai {{ $regulasis->lastItem() }} dari
                {{ $regulasis->total() }} {{ strtolower($title) }}
            </div>
    ...
    @include('admin.manage-content.dokumen.regulasi.create')
    @include('admin.manage-content.dokumen.regulasi.update')
    @include('admin.manage-content.dokumen.regulasi.delete')
</x-admin.layouts>
