<!-- resources/views/admin/manage-content/pengumuman/kelolapengumuman.blade.php -->
<x-admin.layouts>
    ...
    @section('breadcrumb')
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2">pengumuman</span>
            </div>
        </li>
    @endsection
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4">
            <div>
                <h2 class="text-lg font-semibold text-gray-900">Kelola pengumuman</h2>
