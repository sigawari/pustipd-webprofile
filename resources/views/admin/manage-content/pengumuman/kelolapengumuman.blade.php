...
<x-admin.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.manage-content.pengumuman.kelolapengumuman.bulk') }}";
        </script>
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200" style="min-width: 900px;">
                        ...
                        <tbody id="pengumumanTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.manage-content.pengumuman.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        @include('admin.manage-content.pengumuman.create')
        @include('admin.manage-content.pengumuman.update')
        @include('admin.manage-content.pengumuman.delete')
