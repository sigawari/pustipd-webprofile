...
<x-admin.layouts>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-3 sm:p-6 m-3 sm:m-6 shadow-sm">
        ...
        <script>
            window.bulkActionRoute = "{{ route('admin.manage-content.applayanan.bulk') }}";
        </script>
        <script>
        ...
        <div class="flex flex-col gap-3 mb-4 sm:mb-6">
            <div class="relative">
                ...
                <input type="search" id="search-input" value="{{ request('search') }}"
                    data-url="{{ route('admin.manage-content.applayanan.index') }}" data-target="appLayananTableBody"
                ...
                <div class="overflow-hidden border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="appLayananTableBody" class="bg-white divide-y divide-gray-200">
                            @include('admin.manage-content.applayanan.partials.table_body')
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    @include('admin.manage-content.applayanan.create')
    @include('admin.manage-content.applayanan.update')
    @include('admin.manage-content.applayanan.delete')
</x-admin.layouts>
