...
<div id="UpdateModal-{{ $faq->id }}" 
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 relative transform transition-all duration-300 ease-out scale-95">
        ...
        <form method="POST" action="{{ route('admin.manage-content.faq.update', $faq->id) }}">
            ...
            <!-- Pertanyaan -->
            <div class="mb-4">
                <label for="question-{{ $faq->id }}" class="block text-sm font-medium text-gray-700 mb-2">Pertanyaan</label>
            ...
            <!-- Jawaban -->
            <div class="mb-4">
                <label for="answer-{{ $faq->id }}" class="block text-sm font-medium text-gray-700 mb-2">Jawaban</label>
            ...
            <!-- Status -->
            <div class="mb-4">
                <label for="status-{{ $faq->id }}" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
