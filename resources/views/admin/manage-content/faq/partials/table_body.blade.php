    ...
    <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            @php
                ...
                $color = $statusColors[$faq->status] ?? 'bg-gray-100 text-gray-800';
            @endphp
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
            <div class="flex items-center space-x-2">
                ...
                @if ($faq->status === 'archived')
                    ...
                    <button onclick="quickStatusChange({{ $faq->id }}, 'draft')"
                    ...
                    <button onclick="permanentDeleteFaq({{ $faq->id }})"
                ...
                @else
                    ...
                    <!-- Archive -->
                    <button onclick="softDeleteFaq({{ $faq->id }})"
