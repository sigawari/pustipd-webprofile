                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center bg-white">
                                            <div class="text-center">
                                                ...
                                                <p class="text-lg font-medium text-gray-900 mb-2">Belum ada SOP
                                                    tersedia</p>
                                                <p class="text-gray-600">SOP akan segera ditambahkan oleh admin
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                ...
                @if ($sops->hasPages())
                    <div class="mt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div class="text-sm text-secondary">
                            Menampilkan {{ $sops->firstItem() ?? 0 }} sampai {{ $sops->lastItem() ?? 0 }}
                            dari {{ $sops->total() ?? 0 }} SOP
                        </div>
