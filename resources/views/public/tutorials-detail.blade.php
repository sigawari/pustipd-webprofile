    ...
    <section id="tutorial-detail" class="py-20 mt-8 bg-gradient-to-br from-gray-50 to-blue-50">
        <div class="container mx-auto px-3 sm:px-8 md:px-14">
            ...
            <div class="text-center mb-8 group">
                <h2 class="text-4xl md:text-5xl font-bold text-secondary relative inline-block mb-2">
                    Tutorial
                </h2>
            ...
            <div
                class="bg-white rounded-3xl p-6 sm:p-10 lg:p-12 mx-auto max-w-4xl relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-1.5 before:bg-gradient-to-r before:from-[#062749] before:to-blue-100">
                <!-- Tutorial Header Section -->
                <div
                    class="rounded-3xl p-1 sm:p-4 lg:px-8 mb-2 relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-1.5">
                    <h1 class="text-gray-800 text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-3 text-center bg-gradient-to-r from-[#062749] to-blue-600 bg-clip-text"
                        id="judul-tutorial">
                        Tutorial Penggantian Email
                    </h1>

                    <div class="text-[#062749] font-semibold text-base mb-4 text-center">
                    ...
                    <!-- Share button -->
                    <div class="flex flex-col items-center relative my-3">
                        <button
                            class="bg-[#062749] text-white font-semibold border-none outline-none rounded-lg px-7 py-3 text-base cursor-pointer shadow-lg flex items-center gap-3 transition-all duration-300 hover:bg-[#82BEE0] hover:-translate-y-0.5 hover:shadow-xl"
                            id="mainShareBtn" type="button">
                        ...
                        <div class="hidden flex-row gap-3 mt-3 bg-white rounded-2xl shadow-2xl px-6 py-3 z-20 border border-blue-100 animate-fade-in"
                            id="shareChoices" tabindex="0">
                            <button
                                class="bg-blue-50 text-[#82BEE0] rounded-lg px-5 py-2 border border-[#82BEE0] outline-none cursor-pointer font-semibold text-sm flex items-center gap-2 transition-all duration-200 hover:bg-[#82BEE0] hover:text-white hover:-translate-y-px hover:shadow-lg"
                            ...
                            <button
                                class="bg-blue-50 text-[#82BEE0] rounded-lg px-5 py-2 border border-[#82BEE0] outline-none cursor-pointer font-semibold text-sm flex items-center gap-2 transition-all duration-200 hover:bg-[#82BEE0] hover:text-white hover:-translate-y-px hover:shadow-lg"
                                onclick="copyTutorialLink()" type="button" title="Salin Link">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 24 24">
                ...
                <!-- Konten Tutorial -->
                <div class="text-[#062749] text-lg leading-relaxed">
                    <!-- Langkah 1 -->
                    <div
                        class="bg-gradient-to-br from-[#062749]/5 to-blue-50 border-2 border-[#82BEE0] rounded-2xl p-6 my-8 relative transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl">
                        <h4 class="text-[#062749] font-bold text-xl mb-4 flex items-center gap-2">
                            <span
                                class="bg-[#062749] text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">1</span>
                            Persiapan Awal
                        </h4>

                        <!-- Placeholder untuk gambar -->
                        <div
                            class="w-full max-w-md h-48 bg-gradient-to-br from-green-50 to-green-100 border-2 border-dashed border-blue-100 rounded-xl my-4 mx-auto flex flex-col items-center justify-center text-[#82BEE0] text-sm font-medium text-center transition-all duration-300 hover:bg-gradient-to-br hover:from-green-100 hover:to-blue-50 hover:border-[#82BEE0]">
                    ...
                    <div
                        ...
                        <h4 class="text-[#062749] font-bold text-xl mb-4 flex items-center gap-2">
                            <span
                                class="bg-[#062749] text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">2</span>
                        ...
                        <p>
                            ...
                            biasanya terletak di pojok kanan atas dashboard. Klik pada menu tersebut untuk membuka
                    ...
                    <!-- Tutorial Tip -->
                    <div
                        class="bg-gradient-to-br from-yellow-100 to-yellow-200 border-l-4 border-yellow-500 rounded-r-2xl p-6 my-8 text-yellow-800 italic relative">
                        <div class="text-2xl absolute top-4 left-4">💡</div>
                        <div class="ml-10">
                    ...
                    <div
                        ...
                        <h4 class="text-[#062749] font-bold text-xl mb-4 flex items-center gap-2">
                            <span
                                class="bg-[#062749] text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">3</span>
                            Ubah Alamat Email
                        </h4>
                    ...
                    <div
                        ...
                        <h4 class="text-[#062749] font-bold text-xl mb-4 flex items-center gap-2">
                            <span
                                class="bg-[#062749] text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">4</span>
                    ...
                    <div
                        ...
                        <h4 class="text-[#062749] font-bold text-xl mb-4 flex items-center gap-2">
                            <span
                                class="bg-[#062749] text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">5</span>
                    ...
                    <div
                        ...
                        <div class="ml-10">
                            ...
                            ragu untuk menghubungi tim PUSTIPD melalui kontak yang tersedia di bawah ini.
                        </div>
                    </div>

                    <p class="mt-8 text-center p-6 bg-gray-50 rounded-2xl border-2 border-gray-200">
