...
namespace App\Models\ManageContent\KelolaPengumuman;
...
class KelolaPengumuman extends Model
{
    protected $table = 'kelola_pengumumans';

    /** @use HasFactory<\Database\Factories\KelolaPengumumanFactory> */
    use HasFactory;
    ...
    /**
     * Scope untuk pengumuman yang published.
     */
    ...
    /**
     * Scope untuk pengumuman yang draft.
     */
    ...
    /**
     * Scope untuk pengumuman yang masih valid (belum expired).
     */
    ...
    /**
     * Check apakah pengumuman urgent.
     */
    ...
    /**
     * Check apakah pengumuman masih valid.
     */
    ...
    /**
     * Check apakah pengumuman aktif (published dan valid).
     */
    ...
    /**
     * Get pengumuman untuk public display.
     */
    ...
    /**
     * Get pengumuman urgent untuk alert.
     */
