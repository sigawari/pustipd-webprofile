...
class VisiMisiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.manage-content.tentang.visi-misi.index', [
    ...
    {
        return view('admin.manage-content.tentang.visi-misi.create', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('admin.manage-content.tentang.visi-misi.index') // ← PERBAIKI
    ...
    public function edit($index)
    {
        ...
        if (!isset($visiMisi->misi[$index])) {
            return redirect()
                ->route('admin.manage-content.tentang.visi-misi.index')
                ->with('error', 'Misi tidak ditemukan!');
        }
    
        return view('admin.manage-content.tentang.visi-misi.update', [
            'title' => 'Edit Misi',
            'visiMisi' => $visiMisi,
    ...
    public function delete($index)
    {
        ...
        return view('admin.manage-content.tentang.visi-misi.delete', [
            'title' => 'Hapus Misi',
            'visiMisi' => $visiMisi,
            'misiIndex' => $index,
