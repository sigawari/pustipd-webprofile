<?php
// app/Http/Controllers/Admin/ManageContent/StrukturOrganisasiController.php
...
class StrukturOrganisasiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.manage-content.tentang.struktur-organisasi.index', compact(
    ...
    public function create()
    {
        ...
        return view('admin.manage-content.tentang.tentang.struktur-organisasi.create', compact(
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.manage-content.tentang.tentang.struktur-organisasi.index')
