...
class SopController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // AJAX response
        if ($request->ajax()) {
            return view('admin.manage-content.dokumen.sop.partials.table_body', compact('title', 'sops'))->render();
        }

        // Render full view
        return view('admin.manage-content.dokumen.sop.index', compact('title', 'sops'));
    }
    ...
    {
        return view('admin.manage-content.dokumen.sop.create', [
            'title' => 'Tambah SOP'
        ]);
    }
    ...
    {
        return view('admin.manage-content.dokumen.sop.show', [
            'title' => 'Detail Sop',
            'Sop' => $sop
        ]);
    }
