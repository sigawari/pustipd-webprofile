...
class PanduanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // AJAX response
        if ($request->ajax()) {
            return view('admin.manage-content.dokumen.panduan.partials.table_body', compact('title', 'panduans'))->render();
        }

        // Render full view
        return view('admin.manage-content.dokumen.panduan.index', compact('title', 'panduans'));
    }
    ...
    {
        return view('admin.manage-content.dokumen.panduan.create', [
    ...
    {
        return view('admin.manage-content.dokumen.panduan.show', [
